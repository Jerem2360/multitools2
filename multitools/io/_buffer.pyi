...
class Buffer(_Generic[_T], metaclass=MultiMeta):
    @abstractmethod
...
class BytesBuffer(Buffer[bytes], metaclass=MultiMeta):
    def __init__(self, value: bytes = ...) -> None: ...
    def read(self, size: int, **kwargs) -> bytes: ...
    def write(self, data: bytes, **kwargs) -> int: ...


class StrBuffer(Buffer[str], metaclass=MultiMeta):
...
class FileBuffer(Buffer[str], metaclass=MultiMeta):
    @_overload
