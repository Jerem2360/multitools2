...
class Pointer(int):
    ...
    @staticmethod
    def allocate(size: int) -> Pointer[_PT]: ...
    @classmethod
    def addressof(cls, obj: _PtrType) -> Pointer[_PT]: ...
    def deref(self) -> _PT: ...
    def __repr__(self) -> str: ...
    def __getitem__(self, item: int) -> _PtrType: ...
    def __setitem__(self, key: int, value: _PT) -> None: ...
    def __iter__(self) -> Pointer: ...
    def __next__(self) -> _PT: ...
