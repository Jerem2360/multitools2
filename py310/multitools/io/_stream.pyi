...
class Stream(_Generic[_T], metaclass=MultiMeta):
    @abstractmethod
...
class TextOutput(OStream[str], metaclass=MultiMeta):
...
class TextInput(IStream[str], metaclass=MultiMeta):
    def __init__(self, buffer: _buffer.Buffer[str]) -> None: ...
    def __gethandle__(self) -> _buffer.Buffer[str]: ...
...
class BytesOutput(OStream[bytes], metaclass=MultiMeta):
...
class BytesInput(IStream[bytes], metaclass=MultiMeta):
    def __init__(self, buffer: _buffer.Buffer[bytes]) -> None: ...
    def __gethandle__(self) -> _buffer.Buffer[bytes]: ...
...
class FileOutput(OStream[str], metaclass=MultiMeta):
...
class FileInput(IStream[str], metaclass=MultiMeta):
    def __init__(self, buffer: _buffer.FileBuffer) -> None: ...
    def __gethandle__(self) -> _buffer.FileBuffer: ...
